		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App SAPUI5",
									"targetURL": "#logaligroupinvoices2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupinvoices2-display": {
								"semanticObject": "logaligroupinvoices2",
								"action": "display",
								"description": "A Fiori application SAPUI5",
								"title": "App SAPUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.invoices2",
									"url": sap.ui.require.toUrl("logaligroup/invoices2")
								}
							}
						}
					}
